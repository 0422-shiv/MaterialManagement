<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.as.mm.model.Admin" %>
...
<body class="fix-header card-no-border">
	<% Admin E=(Admin)session.getAttribute("ADMINSESSION"); %>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="http://localhost:7070/Logout"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    <!-- User profile image -->
                    <div class="profile-img"> <img src="/AdminImage/AnshulSharma.JPG" alt="user" />
                    ...
                    <div class="profile-text">
                            <h5>Admin</h5>
                               <a href="" class="http://localhost:7070/Logout" data-toggle="tooltip" title="Logout"><i class="mdi mdi-power"></i></a>

                        <div class="dropdown-menu animated flipInY">
                        <!-- text-->

                        <a href="http://localhost:7070/Logout" class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a>
                        <!-- text-->
                        </div>
                    </div>
                </div>
...
<li><a class="has-arrow waves-effect waves-dark" href='view' target="mw"><i class="mdi mdi-file"></i><span class="hide-menu">Add Employee</span></a></li>
<li><a class="has-arrow waves-effect waves-dark" href='display' target="mw"><i class="mdi mdi-file"></i><span class="hide-menu">Display Employee</span></a></li>
<li><a class="has-arrow waves-effect waves-dark" href='AdminLogout' target="_blank" ><i class="mdi mdi-file"></i><span class="hide-menu">Logout</span></a></li>
